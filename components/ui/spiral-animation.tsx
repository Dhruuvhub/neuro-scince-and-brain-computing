...
class AnimationController {
  ...
  constructor(
    ...
    // 初始化
    this.setupRandomGeneratorAndCreateStars()
    this.setupTimeline()
  }

  // Expose private values for Star projection
  public getCameraZ() {
    return this.cameraZ
  }
  ...
  // 设置随机数生成器 + 创建星星
  private setupRandomGeneratorAndCreateStars() {
...
export function SpiralAnimation({
  ...
  useEffect(() => {
    ...
    // 使用 setTransform 避免重复 scale 累积
    ctx.setTransform(dpr, 0, 0, dpr, 0, 0)

    animationRef.current = new AnimationController(canvas, ctx, dpr, size, background)
